...
---@field IncludeAnimationNames TArray<FString>
---@field ExcludeAnimationNames TArray<FString>
---@field WarmUpFrames FFrameNumber
---@field DelayBeforeStart FFrameNumber
---@field bUseCustomTimeRange boolean
---@field CustomStartFrame FFrameNumber
---@field CustomEndFrame FFrameNumber
---@field CustomDisplayRate FFrameRate
...
---@field BindingReferences FUpgradedLevelSequenceBindingReferences
...
---@field WeakLinker TWeakObjectPtr<UMovieSceneEntitySystemLinker>
---@field InstanceId uint16
---@field InstanceSerial uint16
