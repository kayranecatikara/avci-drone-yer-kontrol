...
---@enum EMovieSceneBreadcrumbMode
local EMovieSceneBreadcrumbMode = {
    Sparse = 0,
    Dense = 1,
...
local EMovieSceneConditionScope = {
    Global = 0,
    Binding = 1,
    OwnerObject = 2,
...
---@enum EMovieSceneGroupConditionOperator
local EMovieSceneGroupConditionOperator = {
    And = 0,
    Or = 1,
    Xor = 2,
...
local EMovieSceneSequenceCompilerMask = {
    Hierarchy = 1,
