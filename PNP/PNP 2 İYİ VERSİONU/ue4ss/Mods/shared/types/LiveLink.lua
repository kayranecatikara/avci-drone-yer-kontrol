...
---@class FLiveLinkVirtualSubjectBoneAttachment
---@field ParentSubject FLiveLinkSubjectName
---@field ParentBone FName
---@field ChildSubject FLiveLinkSubjectName
---@field ChildBone FName
---@field LocationOffset FVector
---@field RotationOffset FRotator
local FLiveLinkVirtualSubjectBoneAttachment = {}
...
---@field Attachments TArray<FLiveLinkVirtualSubjectBoneAttachment>
---@field LocationBehavior EBoneTransformResolution
---@field RotationBehavior EBoneTransformResolution
...
---@param SubjectName FLiveLinkSubjectName
---@return ELiveLinkSubjectState
function ULiveLinkBlueprintLibrary:GetLiveLinkSubjectState(SubjectName) end
...
---@class ULiveLinkCustomTimeStep : UGenlockedCustomTimeStep
---@field LiveLinkDataRate FFrameRate
---@field SubjectKey FLiveLinkSubjectKey
---@field bLockStepMode boolean
---@field FrameRateDivider uint32
---@field TimeoutInSeconds double
local ULiveLinkCustomTimeStep = {}
...
---@field DefaultSettingsClass FSoftClassPath
---@field FrameInterpolationProcessor TSubclassOf<ULiveLinkFrameInterpolationProcessor>
...
---@field bPreProcessRebroadcastFrames boolean
---@field bTranslateRebroadcastFrames boolean
...
---@class ULiveLinkSkeletonRemapper : ULiveLinkSubjectRemapper
---@field ReferenceSkeleton TSoftObjectPtr<USkeletalMesh>
local ULiveLinkSkeletonRemapper = {}
...
---@class ULiveLinkTransformDeadbandPreProcessor : ULiveLinkFramePreProcessor
---@field bEnableDeadband boolean
---@field TranslationDeadband float
---@field RotationDeadbandInDegrees float
local ULiveLinkTransformDeadbandPreProcessor = {}



---@class ULiveLinkTransformRoleToAnimation : ULiveLinkFrameTranslator
---@field OutputBoneName FName
local ULiveLinkTransformRoleToAnimation = {}
