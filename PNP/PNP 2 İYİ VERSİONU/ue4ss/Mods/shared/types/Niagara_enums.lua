...
local ENDIDataChannelSpawnScaleMode = {
    Override = 0,
    Scale = 1,
    Max = 2,
}
...
local ENDISocketReaderSourceMode = {
    Default = 0,
...
---@enum ENSMInitialMeshOrientationMode
local ENSMInitialMeshOrientationMode = {
    None = 0,
    Random = 1,
    OrientToAxis = 2,
...
local ENiagaraAssetTagDefinitionImportance = {
    Primary = 0,
    Secondary = 1,
    Internal = 2,
...
local ENiagaraExecutionStateManagement = {
    Awaken = 0,
...
---@enum ENiagaraLoopDurationMode
local ENiagaraLoopDurationMode = {
    Fixed = 0,
    Infinite = 1,
...
local ENiagaraStatelessFeatureMask = {
    ExecuteGPU = 1,
    ExecuteCPU = 2,
    None = 0,
    ExecuteAll = 3,
