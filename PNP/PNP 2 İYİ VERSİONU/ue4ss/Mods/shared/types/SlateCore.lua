...
---@field ImageSizeOverride TOptional<FVector2D>
...
---@field bForceMonospaced boolean
---@field bMaterialIsStencil boolean
---@field MonospacedWidth float
...
---@field SeparatorThickness float
...
---@field VerticalAlignmentOverride TOptional<EVerticalAlignment>
local FToolBarStyle = {}
