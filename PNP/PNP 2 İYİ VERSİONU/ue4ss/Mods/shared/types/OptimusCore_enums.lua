...
---@enum EOptimusDeformerExecutionPhase
local EOptimusDeformerExecutionPhase = {
...
local EOptimusExecutionDomainType = {
    DomainName = 0,
    Expression = 1,
...
---@enum EOptimusValueType
local EOptimusValueType = {
    Invalid = 0,
    Constant = 1,
    Variable = 2,
...
---@enum EOptimusValueUsage
local EOptimusValueUsage = {
    None = 0,
    CPU = 1,
    GPU = 2,
