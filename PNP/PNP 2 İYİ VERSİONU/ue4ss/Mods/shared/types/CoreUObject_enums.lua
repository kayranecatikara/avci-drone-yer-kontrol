...
local EInputDeviceAnalogStickMask = {
    None = 0,
    Left = 1,
    Right = 2,
...
local ETestInstanceDataObjectBird = {
    TIDOB_None = 0,
    TIDOB_Cardinal = 1,
    TIDOB_Crow = 2,
    TIDOB_Eagle = 3,
...
local ETestInstanceDataObjectDirection = {
    None = 0,
    North = 1,
    East = 2,
    South = 4,
...
local ETestInstanceDataObjectDirectionAlternate = {
    None = 0,
    Up = 1,
    Down = 2,
    North = 4,
...
local ETestInstanceDataObjectFruit = {
    None = 0,
    Apple = 1,
    Banana = 2,
    Lemon = 3,
...
local ETestInstanceDataObjectFruitAlternate = {
    None = 0,
    Apple = 1,
    Cherry = 2,
    Orange = 3,
...
---@enum ETestInstanceDataObjectFruitAlternateNamespace
local ETestInstanceDataObjectFruitAlternateNamespace = {
    None = 0,
    Apple = 1,
    Cherry = 2,
    Orange = 3,
...
---@enum ETestInstanceDataObjectFullFlags
...
local ETestInstanceDataObjectGrain = {
    None = 0,
    Barley = 1,
    Corn = 2,
    Quinoa = 3,
...
local ETestInstanceDataObjectGrainAlternate = {
    None = 0,
    Corn = 1,
    Rice = 2,
    Rye = 3,
...
---@enum ETestInstanceDataObjectGrainAlternateEnumClass
local ETestInstanceDataObjectGrainAlternateEnumClass = {
    None = 0,
    Corn = 1,
    Rice = 2,
    Rye = 3,
