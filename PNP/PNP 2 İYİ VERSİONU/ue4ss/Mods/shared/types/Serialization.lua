...
---@field RawClass UClass
---@field WrappedClass UClass
...
---@field StrOptional TOptional<FString>
---@field StrOptionalUnset TOptional<FString>
---@field IntOptional TOptional<int32>
---@field IntOptionalUnset TOptional<int32>
---@field NameOptional TOptional<FName>
---@field NameOptionalUnset TOptional<FName>
---@field StructOptional TOptional<FStructSerializerBuiltinTestStruct>
---@field StructOptionalUnset TOptional<FStructSerializerBuiltinTestStruct>
...
---@field Optionals FStructSerializerOptionalTestStruct
