...
local EEditorPropertyValueState = {
    Default = 0,
    Overridden = 1,
    NotFound = 2,
    AccessDenied = 3,
...
local EFirstPersonPrimitiveType = {
    None = 0,
    FirstPerson = 1,
...
---@enum ELocalExposureMethod
local ELocalExposureMethod = {
    Bilateral = 0,
    Fusion = 1,
...
---@enum EMaterialAttributeBlendFunction
local EMaterialAttributeBlendFunction = {
    Horizontal = 0,
    Vertical = 1,
...
---@enum EMegaLightsShadowMethod
local EMegaLightsShadowMethod = {
    Default = 0,
    RayTracing = 1,
    VirtualShadowMap = 2,
...
local EOverrideBlockOnSlowStreaming = {
    NoOverride = 0,
    Blocking = 1,
    NotBlocking = 2,
...
local EPositionIncludedOffsets = {
    IncludeOffsets = 0,
    ExcludeOffsets = 1,
...
local ERuntimePartitionCellBoundsMethod = {
    UseContent = 0,
    UseCellBounds = 1,
...
local ERuntimeVirtualTextureMaterialQuality = {
    Low = 0,
    Medium = 1,
    High = 2,
    Epic = 3,
...
local ETextureCollectionMemberType = {
    Texture2D = 0,
    TextureCube = 1,
    Texture2DArray = 2,
    TextureCubeArray = 3,
