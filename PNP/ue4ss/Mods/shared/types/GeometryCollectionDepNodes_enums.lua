---@enum EDataflowTransferNodeBoundingVolume
local EDataflowTransferNodeBoundingVolume = {
...
---@enum EDataflowTransferNodeFalloff
local EDataflowTransferNodeFalloff = {
...
---@enum EDataflowTransferNodeSampleScale
local EDataflowTransferNodeSampleScale = {
