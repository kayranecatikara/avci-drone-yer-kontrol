...
---@field SourceMode ENDIGeometryCollection_SourceMode
---@field DefaultGeometryCollection UGeometryCollection
---@field GeometryCollectionActor TSoftObjectPtr<AGeometryCollectionActor>
---@field SourceComponent UGeometryCollectionComponent
---@field GeometryCollectionUserParameter FNiagaraUserParameterBinding
---@field bIncludeIntermediateBones boolean
