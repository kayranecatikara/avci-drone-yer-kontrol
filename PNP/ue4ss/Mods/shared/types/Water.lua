...
---@field ExclusionMode EWaterExclusionMode
---@field WaterBodies TArray<TSoftObjectPtr<AWaterBody>>
local AWaterBodyExclusionVolume = {}



---@class AWaterBodyIsland : AActor
---@field WaterCurveSettings FWaterCurveSettings
---@field WaterHeightmapSettings FWaterBodyHeightmapSettings
---@field WaterWeightmapSettings TMap<FName, FWaterBodyWeightmapSettings>
---@field SplineComp UWaterSplineComponent
...
---@field WaterInfoTextureArray UTextureRenderTarget2DArray
---@field WaterInfoTextureArrayNumSlices int32
...
---@field bAutoIncludeLandscapesAsTerrain boolean
---@field WaterZoneIndex int32
---@field OnWaterInfoTextureArrayCreated FWaterZoneOnWaterInfoTextureArrayCreated
local AWaterZone = {}

---@param InFarMaterial UMaterialInterface
function AWaterZone:SetFarMeshMaterial(InFarMaterial) end
---@return int32
function AWaterZone:GetWaterZoneIndex() end
...
---@class FShallowWaterSimulationGrid
---@field ArrayValues TArray<FVector4>
---@field NumCells FIntVector2
---@field Position FVector
---@field Size FVector2D
---@field Dx FVector2D
---@field BakedTexture UTexture2D
local FShallowWaterSimulationGrid = {}
...
---@field ModulationTexture TSoftObjectPtr<UTexture2D>
...
---@class UBakedShallowWaterSimulationComponent : UPrimitiveComponent
---@field SimulationData FShallowWaterSimulationGrid
local UBakedShallowWaterSimulationComponent = {}
...
---@field bFindWaterBodyOnSpawn boolean
---@field bEvaluateSystemDepth boolean
---@field bEvaluateSystemDepthPerFrame boolean
---@field SourceBodyComponent UObject
...
---@field WaterHeightmapSettings FWaterBodyHeightmapSettings
---@field LayerWeightmapSettings TMap<FName, FWaterBodyWeightmapSettings>
...
---@field BakedShallowWaterSim TWeakObjectPtr<UBakedShallowWaterSimulationComponent>
---@field bUseBakedSimForQueriesAndPhysics boolean
...
---@param InMaterial UMaterialInterface
function UWaterBodyComponent:SetWaterStaticMeshMaterial(InMaterial) end
---@param InMaterial UMaterialInterface
function UWaterBodyComponent:SetWaterMaterial(InMaterial) end
...
---@param InMaterial UMaterialInterface
function UWaterBodyComponent:SetUnderwaterPostProcessMaterial(InMaterial) end
---@param bShapeOrPositionChanged boolean
---@param bWeightmapSettingsChanged boolean
---@param bUserTriggeredChanged boolean
function UWaterBodyComponent:OnWaterBodyChanged(bShapeOrPositionChanged, bWeightmapSettingsChanged, bUserTriggeredChanged) end
...
---@return UMaterialInterface
function UWaterBodyComponent:GetRiverToOceanTransitionMaterial() end
---@return UMaterialInstanceDynamic
function UWaterBodyComponent:GetRiverToLakeTransitionMaterialInstance() end
---@return UMaterialInterface
function UWaterBodyComponent:GetRiverToLakeTransitionMaterial() end
---@return float
...
---@field bIsDilatedMesh boolean
---@field bIsConservativeRasterCompatible boolean
...
---@field bCenterOnWaterZone boolean
...
function UWaterBodyRiverComponent:SetOceanTransitionMaterial(InMat) end
---@param InMat UMaterialInterface
function UWaterBodyRiverComponent:SetLakeTransitionMaterial(InMat) end
---@param InLakeTransition UMaterialInterface
---@param InOceanTransition UMaterialInterface
function UWaterBodyRiverComponent:SetLakeAndOceanTransitionMaterials(InLakeTransition, InOceanTransition) end
...
---@field QuadTreeResolution FIntPoint
---@field UsedMaterials TSet<UMaterialInterface>
---@field MaterialToMID TMap<UMaterialInterface, UMaterialInstanceDynamic>
...
---@class UWaterTerrainComponent : UActorComponent
---@field WaterZoneOverride TSoftObjectPtr<AWaterZone>
local UWaterTerrainComponent = {}
