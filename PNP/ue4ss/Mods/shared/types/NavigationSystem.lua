...
---@field AreaClassToReplace TSubclassOf<UNavArea>
...
---@param NewAreaClassToReplace TSubclassOf<UNavArea>
function ANavModifierVolume:SetAreaClassToReplace(NewAreaClassToReplace) end
...
---@field bDrawIfNavDataIsReadyInRadius boolean
---@field bDrawIfNavDataIsReadyToQueryTargetActor boolean
---@field bDrawRaycastToQueryTargetActor boolean
---@field QueryTargetActor AActor
...
---@field RadiusUsedToValidateNavData float
...
---@field MaxVerticalMergeError int32
---@field MaxSimplificationError float
---@field SimplificationElevationRatio float
...
---@field LedgeSlopeFilterMode ENavigationLedgeSlopeFilterMode
...
---@field bGenerateNavLinks boolean
...
---@field NavLinkJumpDownConfig FNavLinkGenerationJumpDownConfig
...
---@field JumpLength float
---@field JumpDistanceFromEdge float
---@field JumpMaxDepth float
---@field JumpHeight float
---@field JumpEndsHeightTolerance float
---@field SamplingSeparationFactor float
---@field FilterDistanceThreshold float
---@field LinkBuilderFlags uint16
---@field AreaClass TSubclassOf<UNavAreaBase>
---@field LinkProxyClass TSubclassOf<UBaseGeneratedNavLinksProxy>
---@field LinkProxyId FNavLinkId
---@field LinkProxy UBaseGeneratedNavLinksProxy
---@field bLinkProxyRegistered boolean
...
---@field bHeightFieldLayers boolean
...
---@field bSkipContourSimplification boolean
---@field bTileCacheContours boolean
---@field bTileCachePolyMesh boolean
---@field bTileCacheDetailMesh boolean
---@field LinkGenerationDebugFlags uint16
---@field LinkGenerationSelectedEdge int32
...
---@class UNavigationObjectRepository : UWorldSubsystem
local UNavigationObjectRepository = {}
...
---@field InvokersMaximumDistanceFromSeed double
...
---@field Repository UNavigationObjectRepository
...
---@field bUpdateNavDataOnSplineChange boolean
---@field AttachedSpline FComponentReference
---@field StrokeWidth double
---@field StrokeHeight double
---@field SubdivisionLOD ESubdivisionLOD
