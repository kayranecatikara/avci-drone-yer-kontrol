...
---@field FlatnessRatio FChaosClothWeightedValue
...
---@field bUseSelfCollisionSpheres boolean
---@field SelfCollisionSphereRadius float
---@field SelfCollisionSphereStiffness float
---@field SelfCollisionSphereRadiusCullMultiplier float
...
---@field bEnableOuterDrag boolean
---@field OuterDrag FChaosClothWeightedValue
---@field Lift FChaosClothWeightedValue
---@field bEnableOuterLift boolean
---@field OuterLift FChaosClothWeightedValue
...
---@param OuterDrag FVector2D
---@param OuterLift FVector2D
...
---@param BucklingRatio FVector2D
---@param BucklingStiffness FVector2D
