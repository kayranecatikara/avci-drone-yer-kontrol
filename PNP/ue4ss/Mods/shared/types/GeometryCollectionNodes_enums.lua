...
---@enum EDataflowTransferVertexAttributeNodeBoundingVolume
local EDataflowTransferVertexAttributeNodeBoundingVolume = {
    Vertex = 0,
    Triangle = 1,
    Dataflow_Max = 2,
...
---@enum EDataflowTransferVertexAttributeNodeFalloff
local EDataflowTransferVertexAttributeNodeFalloff = {
    Squared = 0,
    Linear = 1,
    None = 2,
    Dataflow_Max = 3,
...
local EDataflowTransferVertexAttributeNodeSourceScale = {
    Component_Edge = 0,
    Asset_Edge = 1,
    Asset_Bound = 2,
    Dataflow_Max = 3,
...
---@enum ESelectionByAttrGroup
local ESelectionByAttrGroup = {
    Vertices = 0,
    Faces = 1,
    Transform = 2,
    Geometry = 3,
