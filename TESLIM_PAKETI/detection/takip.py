# -*- coding: utf-8 -*-
"""TAKIP — boxmot HybridSort adaptoru. Eski Takipci/TakipCfg arayuzunu korur;
HybridSort kareyi (frame=bgr) ister, dt/H_cmc/cmc_max_kaydirma yok sayilir."""
import numpy as np
...
CMC_METHOD = "ecc"      # kamera-hareket telafisi (HybridSort varsayilani)


class TakipCfg:
    """Eski API uyumu: server predict esiginde cfg.CONF_DUSUK kullanir."""
...
class Takipci:
    ...
    def sifirla(self):
        # Lazy import: agir boxmot ilk tracker'da yuklenir.
    ...
    def guncelle(self, tespitler, dt=None, H_cmc=None, cmc_max_kaydirma=None, frame=None):
        """tespitler: [{cx,cy,w,h,conf,...}] (piksel); frame: bgr (sart).
        -> en yuksek conf track dict | None. dt/H_cmc/cmc_max_kaydirma yok sayilir."""
        ...
        # Tek-hedef: en yuksek conf'lu track.
