...
#  (Fatih / gps-log-server branch'inden alindi; main yapisina
#   uyarlandi: giris noktasi server.py degil main.py'dir —
#   "python web/server.py" dogrudan CALISTIRILMAZ, importlar kirilir.)
# ============================================================
cd "$(dirname "$0")"
