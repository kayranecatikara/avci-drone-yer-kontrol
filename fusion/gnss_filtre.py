...
class GNSSFiltre:
    ...
    # Eski filtre (inovasyonlu_j_v2.GNSSDuzeltici) API uyumu: mevcut cagiranlar
    # (ana_kontrol._hedef_temizle, server sapma olcumu, dev_truth) 'durum_guduum'
    # (cift-u) cagiriyor -> alias ile dokunmadan calisirlar.
    durum_guduum = durum_gudum
