...
ultralytics + torch (CUDA wheel) eklenmeli; best.pt repo kokunde olmali.

Renk notu: ultralytics numpy diziyi BGR varsayar; bu yuzden PIL Image (RGB) GECMEK
en guvenlisidir (YOLO PIL'i dogru RGB isler). server.grab_frame_pil() PIL doner.
"""
...
if __name__ == "__main__":
    import os
    siniflar(os.path.join(os.path.dirname(os.path.abspath(__file__)), "best.pt"))
