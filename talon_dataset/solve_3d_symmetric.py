...
# Target 1 (talon_0001):
# Nose: (804.31, 529.57) - wait, let's use the precise target pixels
# Left wingtip: (889.65, 658.79)
# Right wingtip: (960.04, 351.46)
# Tail: (1024.21, 544.24)
# fin_up: (1009.19, 457.00)
# fin_down: (1004.01, 551.40)

# Target 3 (talon_0003):
# Nose: (860.0, 540.0) -> actually let's project current nose/tail/wingtips to get f3 ground truth!
# Since nose, tail, wingtips are perfectly rigid and already visual aligned, their projections in f3 are:
# nose: 860, tail: 1006, left_wing: 940, right_wing: 920.
# The V-tail tips in talon_0003.png (measured from crop_f3_grid.png):
# fin_up: (972.0, 492.0)
# fin_down: (969.0, 534.0)

# Let's write the loss function for a given assignment of left_tail_fin and right_tail_fin:
...
# TRIAL 1: Left tail fin = fin_up, Right tail fin = fin_down
# Frame 1: Left=(1009.19, 457.00), Right=(1004.01, 551.40)
# Frame 3: Left=(972.0, 492.0), Right=(969.0, 534.0)
print("=== TRIAL 1: Left = UP, Right = DOWN ===")
res1, loss1 = optimize(loss_symmetric_pair, [-20.0, 15.0, 18.0], 
                       args=((1009.19, 457.00), (1004.01, 551.40), (972.0, 492.0), (969.0, 534.0)))
print(f"Optimal coords: x={res1[0]:.4f}, y={res1[1]:.4f}, z={res1[2]:.4f}")
print(f"Total loss: {loss1:.4f} (RMSE = {math.sqrt(loss1/4):.4f} pixels)")

# TRIAL 2: Left tail fin = fin_down, Right tail fin = fin_up
# Frame 1: Left=(1004.01, 551.40), Right=(1009.19, 457.00)
# Frame 3: Left=(969.0, 534.0), Right=(972.0, 492.0)
print("\n=== TRIAL 2: Left = DOWN, Right = UP ===")
res2, loss2 = optimize(loss_symmetric_pair, [-20.0, 15.0, 18.0], 
                       args=((1004.01, 551.40), (1009.19, 457.00), (969.0, 534.0), (972.0, 492.0)))
