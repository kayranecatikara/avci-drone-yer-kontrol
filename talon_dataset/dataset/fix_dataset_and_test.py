...
RAW_CAD = {
    ...
    # DIKKAT (2026-07-08): Veri ureticisi (oyun Lua'si) fin ISIMLERINI ayna-ters
    # uretiyor (Left_Tail_Fin anahtari fiziksel SAG finde durur). Okluzyon
    # karari ile silinecek JSON anahtari eslessin diye buradaki iki satir
    # VERININ KURALINA gore takasli tutulur. (Kanatlar Lua'da dogru, dokunma.)
