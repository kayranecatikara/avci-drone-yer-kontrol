...
# Real visual targets:
# Frame 1: Up-fin=(995, 475), Down-fin=(975, 550)
# Frame 3: Up-fin=(972, 495), Down-fin=(975, 550)
...
# Left tail fin is UP target, which has y < 0 in Python coordinates!
# Right tail fin is DOWN target, which has y > 0 in Python coordinates!
# Let's optimize:
res, loss = optimize(loss_symmetric_pair, [-20.0, -15.0, 15.0], 
                     args=((995.0, 475.0), (975.0, 550.0), (972.0, 495.0), (975.0, 550.0)))
print(f"Optimal coords: x={res[0]:.4f}, y={res[1]:.4f}, z={res[2]:.4f}")
print(f"Total loss: {loss:.4f} (RMSE = {math.sqrt(loss/4):.4f} pixels)")
