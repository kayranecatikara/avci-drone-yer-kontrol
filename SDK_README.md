...
- **Kamera artık DÜZ bakar (0 derece).** Eski FPV yukarı açısı (25/35°) kaldırılmıştır; hedefi merkezlemek için kamera açısı telafisi yapmanıza gerek yoktur.
...
- **Düşük güncelleme hızı:** Telemetri, gerçek bir GPS gibi saniyede yalnızca birkaç kez güncellenebilir.
